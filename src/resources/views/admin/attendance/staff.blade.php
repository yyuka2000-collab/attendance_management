    ...
    <main class="list-main">
        <div class="list-container">
            ...
            <div class="list-month-nav">
                <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $prevMonth]) }}" class="list-month-nav__arrow list-month-nav__arrow--prev">
                    &#8592; 前月
                </a>
                ...
                <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $nextMonth]) }}" class="list-month-nav__arrow list-month-nav__arrow--next">
                    翌月 &#8594;
                </a>
            </div>
                        ...
                        @foreach ($attendances as $attendance)
                            <tr class="list-table__row">
                                ...
                                <td class="list-table__td list-table__td--detail">
                                    @if ($attendance['id'])
                                        <a href="{{ route('admin.attendance.detail', ['id' => $attendance['id']]) }}" class="list-table__detail-link">
                                            詳細
                                    ...
                                    @else
                                        <a href="{{ route('admin.attendance.find', [$user->id, $attendance['date_raw']]) }}" class="list-table__detail-link">
                                            詳細
                                        </a>
                                    @endif
                                </td>
            ...
            {{-- CSV出力ボタン --}}
            <div class="list-csv-row">
                <a href="{{ route('admin.attendance.staff.csv', ['id' => $user->id, 'month' => $currentMonth]) }}" class="list-csv-btn">
                    CSV出力
                </a>
            </div>
